import svgPaths from "./svg-t58ri81i0n";
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[6px] items-center justify-center px-[10px] py-[4px] relative size-full">
          ...
          <div className="flex flex-[1_0_0] flex-col font-['SF_Pro_Display:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#1c1c1c] text-[12px] tracking-[-0.16px]">
            <p className="leading-[16.5px] whitespace-pre-wrap">Gemini 2.5 Flash</p>
          </div>
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[6px] items-center justify-center px-[10px] py-[4px] relative size-full">
          ...
          <div className="flex flex-[1_0_0] flex-col font-['SF_Pro_Display:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px relative text-[12px] text-[rgba(28,28,28,0.4)]" style={{ fontVariationSettings: "'wght' 500" }}>
            <p className="leading-[16.5px] whitespace-pre-wrap">未添加 预设</p>
          </div>
          <AddIcon />
        </div>
      </div>
...
function Component5() {
  return (
    <div className="-translate-y-1/2 absolute left-[-12px] size-[16px] top-1/2" data-name="节点">
    ...
    <div className="bg-[rgba(0,0,0,0.03)] flex-[1_0_0] h-[32px] min-h-px min-w-px relative rounded-[15px]" data-name="Container">
      <div className="flex flex-row items-center justify-end size-full">
        <div className="content-stretch flex gap-[6px] items-center justify-end px-[10px] py-[4px] relative size-full">
          <IconContainer />
          <div className="flex flex-[1_0_0] flex-col font-['SF_Pro_Display:Medium','Noto_Sans_SC:Medium','Noto_Sans_JP:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px overflow-hidden relative text-[#1c1c1c] text-[12px] text-ellipsis whitespace-nowrap" style={{ fontVariationSettings: "'wght' 500" }}>
            <p className="leading-[16.5px] overflow-hidden">图片1</p>
          </div>
          <Component4 />
          <Component5 />
        </div>
...
function Container2() {
  return (
    <div className="bg-[rgba(0,0,0,0.03)] flex-[1_0_0] h-[32px] min-h-px min-w-px relative rounded-[15px]" data-name="Container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[6px] items-center justify-center px-[10px] py-[4px] relative size-full">
          <div className="flex flex-col font-['SF_Pro_Display:Medium','Noto_Sans_SC:Medium','Noto_Sans_JP:Medium',sans-serif] justify-center leading-[0] relative shrink-0 text-[12px] text-[rgba(28,28,28,0.4)] whitespace-nowrap" style={{ fontVariationSettings: "'wght' 500" }}>
...
function TextContainer() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0" data-name="Text Container">
      <div className="flex flex-col font-['SF_Pro_Display:Regular',sans-serif] justify-center leading-[0] not-italic opacity-40 relative shrink-0 text-[#1c1c1c] text-[12px] tracking-[-0.2146px] whitespace-nowrap">
        <p className="leading-[1.5]">Enter text …</p>
      </div>
    </div>
  );
}
...
function Component9() {
  return (
    <div className="h-[2px] relative shrink-0 w-[206px]" data-name="分割线">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 206 2">
        <g id="åå²çº¿">
          <path d="M4 1H202" id="Vector 135" stroke="currentColor" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[8px] top-1/2">
      <div className="absolute inset-[-9.38%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.50017 9.50017">
          <g id="Group 11">
            <path d={svgPaths.p38e49700} id="Vector 103" stroke="currentColor" />
          </g>
        </svg>
      </div>
    </div>
...
function Component11() {
  return (
    <div className="overflow-clip relative shrink-0 size-[16px]" data-name="数值">
      <Group1 />
    </div>
  );
}
...
function MinusIcon() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Minus Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="Minus Icon">
          <path d="M2.49998 6H9.49998" id="Vector" stroke="currentColor" />
        </g>
...
function NumberContainer() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-[20px]" data-name="Number Container">
      <div className="flex flex-col font-['SF_Pro_Display:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1c1c1c] text-[12px] whitespace-nowrap">
        <p className="leading-[16.5px]">2</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[rgba(0,0,0,0.03)] flex-[1_0_0] h-[32px] min-h-px min-w-px relative rounded-[15px]" data-name="Container">
      <div className="flex flex-row items-center justify-end size-full">
        <div className="content-stretch flex gap-[6px] items-center justify-end px-[10px] py-[4px] relative size-full">
          <Component11 />
          <div className="flex flex-[1_0_0] flex-col font-['SF_Pro_Display:Medium','Noto_Sans_JP:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px overflow-hidden relative text-[#1c1c1c] text-[12px] text-ellipsis whitespace-nowrap" style={{ fontVariationSettings: "'wght' 500" }}>
            <p className="leading-[16.5px] overflow-hidden">数量</p>
          </div>
          <MinusIcon />
          <NumberContainer />
          <AddIcon2 />
...
function NumberContainer1() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-[20px]" data-name="Number Container">
      <div className="flex flex-col font-['SF_Pro_Display:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1c1c1c] text-[12px] whitespace-nowrap">
        <p className="leading-[16.5px]">9:16</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-[rgba(0,0,0,0.03)] flex-[1_0_0] h-[32px] min-h-px min-w-px relative rounded-[15px]" data-name="Container">
      <div className="flex flex-row items-center justify-end size-full">
        <div className="content-stretch flex gap-[6px] items-center justify-end px-[10px] py-[4px] relative size-full">
          <Component13 />
          <div className="flex flex-[1_0_0] flex-col font-['SF_Pro_Display:Medium','Noto_Sans_JP:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px overflow-hidden relative text-[#1c1c1c] text-[12px] text-ellipsis whitespace-nowrap" style={{ fontVariationSettings: "'wght' 500" }}>
            <p className="leading-[16.5px] overflow-hidden">尺寸</p>
          </div>
          <NumberContainer1 />
          <div className="flex items-center justify-center relative shrink-0 size-[12px]" style={{ "--transform-inner-width": "300", "--transform-inner-height": "150" } as React.CSSProperties}>
            <div className="-rotate-90 flex-none">
...
function NumberContainer2() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-[20px]" data-name="Number Container">
      <div className="flex flex-col font-['SF_Pro_Display:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1c1c1c] text-[12px] whitespace-nowrap">
        <p className="leading-[16.5px]">2K</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-[rgba(0,0,0,0.03)] flex-[1_0_0] h-[32px] min-h-px min-w-px relative rounded-[15px]" data-name="Container">
      <div className="flex flex-row items-center justify-end size-full">
        <div className="content-stretch flex gap-[6px] items-center justify-end px-[10px] py-[4px] relative size-full">
          <Component15 />
          <div className="flex flex-[1_0_0] flex-col font-['SF_Pro_Display:Medium','Noto_Sans_JP:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px overflow-hidden relative text-[#1c1c1c] text-[12px] text-ellipsis whitespace-nowrap" style={{ fontVariationSettings: "'wght' 500" }}>
            <p className="leading-[16.5px] overflow-hidden">清晰度</p>
          </div>
          <NumberContainer2 />
          <div className="flex items-center justify-center relative shrink-0 size-[12px]" style={{ "--transform-inner-width": "300", "--transform-inner-height": "150" } as React.CSSProperties}>
            <div className="-rotate-90 flex-none">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[4px] relative size-full">
          ...
          <div className="flex flex-[1_0_0] flex-col font-['SF_Pro_Display:Semibold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#1c1c1c] text-[13px] tracking-[-0.2146px]">
            <p className="leading-[22.499px] whitespace-pre-wrap">Image Editor</p>
          </div>
          <Component17 />
        </div>
      </div>
...
function Component18() {
  return (
    <div className="-translate-y-1/2 absolute right-[-24px] size-[16px] top-[calc(50%+0.5px)]" data-name="节点">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="èç¹">
          <circle cx="8" cy="8" fill="currentColor" />
        </g>
