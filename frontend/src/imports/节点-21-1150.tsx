import svgPaths from "./svg-n2nlgz1fte";
...
function Component1() {
  return (
    <div className="absolute backdrop-blur-[10px] backdrop-filter bg-white box-border content-stretch flex flex-col gap-[2px] h-[280px] items-start left-0 p-[4px] rounded-[20px] top-0 w-[240px]" data-name="图片加载节点">
      <Component5 />
      <Frame14 />
    </div>
  );
...
function Component2() {
  return (
    <div className="absolute backdrop-blur-[10px] backdrop-filter bg-white box-border content-stretch flex flex-col gap-[2px] h-[280px] items-start left-[251px] p-[4px] rounded-[20px] top-0 w-[240px]" data-name="图片加载节点">
      <Component7 />
      <Frame17 />
