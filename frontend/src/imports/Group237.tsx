import svgPaths from "./svg-tdbvmnzldr";
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex items-start left-[4px] top-[4px]">
      <Component />
    </div>
  );
}
...
export default function Group1() {
  return (
    <div className="relative size-full">
      <Frame4 />
      <div className="absolute left-0 size-[20px] top-0" data-name="手柄">
        <div className="absolute inset-[-5%]" style={{ "--stroke-0": "rgba(255, 255, 255, 1)" } as React.CSSProperties}>
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
            <path d={svgPaths.p37c5ae40} id="ææ" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeOpacity="0.4" strokeWidth="2" style={{ stroke: "white", strokeOpacity: "0.4" }} />
          </svg>
        </div>
      </div>
      <div className="absolute flex items-center justify-center left-[202px] size-[20px] top-[385px]">
        <div className="flex-none rotate-[180deg]">
          <div className="relative size-[20px]" data-name="手柄">
            <div className="absolute inset-[-5%]" style={{ "--stroke-0": "rgba(255, 255, 255, 1)" } as React.CSSProperties}>
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
                <path d={svgPaths.p37c5ae40} id="ææ" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeOpacity="0.4" strokeWidth="2" style={{ stroke: "white", strokeOpacity: "0.4" }} />
              </svg>
